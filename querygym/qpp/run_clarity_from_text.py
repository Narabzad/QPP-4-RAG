#!/usr/bin/env python3
"""
Run Clarity QPP metric by extracting term frequencies from document text.
This version works with indices that don't have pre-computed document vectors.
"""
...
# ============================================================================
# CLARITY COMPUTATION FUNCTIONS (using document text)
# ============================================================================
...
def get_doc_term_freqs(pid, index_reader):
    ...
    try:
        ...
        # Analyze the text to get terms (same analyzer as used for queries)
    ...
    try:
        ...
        for qid, qtext in query.items():
            ...
            try:
                ...
                rm1_k10 = RM1_from_text(qtokens, pid_list, score_list, index_reader, k_val, mu=1000)
...
def main():
    parser = argparse.ArgumentParser(
        description='Run Clarity QPP metric by extracting terms from document text (k=10)',
    ...
    print("="*80)
    print("CLARITY QPP METRIC COMPUTATION (from document text, k=10)")
    print("="*80)
    ...
    print(f"📊 Computing Clarity (k=10) from document text...\n")
