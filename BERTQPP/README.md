# [BERT-QPP: Contextualized Pre-trained Transformers for Query Performance Prediction](https://drive.google.com/file/d/1pCh6MXUvY5kfBO-twcxlycdErBeKccsT/view)
